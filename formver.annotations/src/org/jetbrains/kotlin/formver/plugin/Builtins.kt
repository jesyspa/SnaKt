 ...
 *
 * **Known limitation:** `exists` in a postcondition will not verify even when the predicate
 * is trivially satisfiable. Place the witness in a precondition or loop invariant instead.
 */
