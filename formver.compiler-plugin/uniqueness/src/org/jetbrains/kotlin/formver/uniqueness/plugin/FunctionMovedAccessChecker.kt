 ...
 */
object FunctionMovedAccessChecker : FirFunctionChecker(MppCheckerKind.Common) {
    ...
    override fun check(declaration: FirFunction) {
        ...
        for (node in graph.nodes) {
            ...
            for (accessExpression in node.resolveAccesses()) {
                ...
                val uniquenessState = uniquenessStateFlows.readInputUniquenessStateOf(node) ?: EmptyUniquenessState
