...
public class PhasedDiagnosticTestGenerated extends AbstractPhasedDiagnosticTest {
  ...
  public class Uniqueness_checker {
    ...
    public void testSpecification() {
      runTest("formver.compiler-plugin/testData/diagnostics/uniqueness_checker/specification.kt");
    }
  ...
  public class Verification {
    ...
    public class Uniqueness {
      ...
      @Test
      @TestMetadata("inherited_unique_property.kt")
      public void testInherited_unique_property() {
        runTest("formver.compiler-plugin/testData/diagnostics/verification/uniqueness/inherited_unique_property.kt");
      }
      ...
      @Test
      @TestMetadata("pure_recursion_nonterminating.kt")
