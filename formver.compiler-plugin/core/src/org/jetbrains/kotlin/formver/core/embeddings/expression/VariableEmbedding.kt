...
class AnonymousVariableEmbedding(n: Int, override val type: TypeEmbedding) : VariableEmbedding {
    override val name: SymbolName = AnonymousName(n)
}

class AnonymousBuiltinVariableEmbedding(n: Int, override val type: TypeEmbedding) : VariableEmbedding {
    override val name: SymbolName = AnonymousBuiltinName(n)
 ...
 */
class LinearizationVariableEmbedding(override val name: SymbolName, override val type: TypeEmbedding) :
    VariableEmbedding
