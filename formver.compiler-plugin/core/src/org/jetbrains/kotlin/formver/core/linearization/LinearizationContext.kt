...
interface LinearizationContext {
     ...
     *
     * An `inhale` is a statement, so a context producing a single Viper expression has nowhere to put one.
     * Facts that would have been inhaled are dropped there, which costs the verifier information but never
     * adds any.
     */
