...
import org.jetbrains.kotlin.formver.core.embeddings.expression.BaseStoredResultExpEmbedding
...
interface LinearizationContext {
    ...
    fun addBaseStoredResultExpEmbedding(embedding: BaseStoredResultExpEmbedding): Exp
